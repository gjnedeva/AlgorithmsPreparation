 ...
 */
public class ImplementListWithArray {
    public static class CustomArrayList {
         ...
         *
         * @param item – the item to be checked * @return if the item exists
         */
        ...
        /**
         * Removes the specified item and returns its index or -1 * if item does not exists
         *
